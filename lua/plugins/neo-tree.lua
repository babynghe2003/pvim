...
local configtree = {
  ...
  git_status_async_options = {
    ...
    -- Add these options to detect changes in submodules
    args = {
      "--recurse-submodules",  -- Check for changes in submodules
      "--ignore-submodules=none"  -- Don't ignore any changes in submodules
    }
  },
  ...
  commands = {
    -- Add a custom command to update submodules
    submodule_update = function()
      local command = "git submodule update --init --recursive"
      vim.fn.system(command)
      -- Refresh Neo-tree after updating submodules
      require("neo-tree.command").execute({ action = "refresh" })
      vim.notify("Submodules updated", vim.log.levels.INFO)
    end
  }, -- A list of functions
  ...
  window = { -- see https://github.com/MunifTanjim/nui.nvim/tree/main/lua/nui/popup for
    ...
    mappings = {
      ...
      -- Add a mapping to update git submodules
      ["gs"] = "submodule_update",
    },
  },
  filesystem = {
